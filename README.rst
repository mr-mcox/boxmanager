...
*pip3 install git+https://github.com/mr-mcox/boxmanager.git@v0.4.3#egg=boxmanager*

If you've already installed it, then you'll need to run a modified version to update:

*pip3 install --upgrade git+https://github.com/mr-mcox/boxmanager.git@v0.4.3#egg=boxmanager*
